...
from sketch_generator_new1 import generate_sketch_with_label
import os
    ...
    def initialize_recognizer(self):
        ...
        try:
            self.recognizer = ArcFaceRecognizer(
                ...
                arcface_model="arcface_r100.onnx",
...
def verify_snapshot():
    ...
    try:
        ...
        if create_sketch:
            from sketch_generator_new1 import generate_sketch_variations
...
if __name__ == '__main__':
    ...
    print(f"Model:           YOLO11n-face + ArcFace R100 ONNX  (RTX 50-series native)")
